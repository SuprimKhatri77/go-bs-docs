...
export const metadata = docsMetadata({
  ...
  description:
    "Date arithmetic for Bikram Sambat dates in Go: AddDays, NextMonth, DaysBetween, StartOfMonth, EndOfYear, DayOfWeek, Age and more in go-bs.",
  path: "/docs/api/arithmetic",
});
